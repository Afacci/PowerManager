...
select case(what)
   ...
   case(26)
        allocate(tempCorrB(num,3,nTrig))
   case(27)
        allocate(presCorrB(num,3,nTrig))
   case(28)
        allocate(altCorrB(num,3,nTrig))
   case(29)
        allocate(tempCorrC(num,3,nTrig))
   case(30)
        allocate(presCorrC(num,3,nTrig))
   case(31)
        allocate(altCorrC(num,3,nTrig))
end select
