...
\hypertarget{classenergy_ad0d7a76ef1e071f3332e04573b6973a3}{\index{energy@{energy}!chselfcons@{chselfcons}}
\index{chselfcons@{chselfcons}!energy@{energy}}
\subsubsection[{chselfcons}]{\setlength{\rightskip}{0pt plus 5cm}real(kind = prec) function energy\-::chselfcons (
\begin{DoxyParamCaption}
\item[{integer, dimension(nm), intent(in)}]{c\-\_\-, }
\item[{integer, intent(in)}]{t}
\end{DoxyParamCaption}
)}}\label{classenergy_ad0d7a76ef1e071f3332e04573b6973a3}
Calculates the thermal self-\/consumption of the trigeneration plant, that is, hte thermal power needed by the absorbtion chillers. \[ U_{ch}^{self} = \sum_{AbsChi} \frac{sp(i)\cdot P_{max}(i)\cdot \vartheta_{env}}{\eta_{ch}(i,sp(i))\cdot \beta_{env}} \] where $sp(i)$ is the set point of the $i$'th machine, $\eta_{ch}$ is the chilling efficiency, and $P_{max}(i)$ is its rated power; $\beta_{env}$ and $\vartheta_{env}$ are the environmental corrections for chilling efficiency, and chilling power, respectively. 
...
Definition at line 307 of file energy.\-f90.



Referenced by euristics\-::chredundant(), and constr\-::constraints().
...
Definition at line 646 of file energy.\-f90.
...
Definition at line 354 of file energy.\-f90.



Referenced by strategies\-::electricaltracking(), economy\-::elrev(), economy\-::grideconomy(), pec(), and strategies\-::thermaltracking().
...
Definition at line 861 of file energy.\-f90.



Referenced by constr\-::elstorageconstr(), and output().
...
Definition at line 536 of file energy.\-f90.
...
Definition at line 471 of file energy.\-f90.
...
Definition at line 413 of file energy.\-f90.



Referenced by economy\-::fuelcost(), and output().

\hypertarget{classenergy_a0f259e2e3c19a27638c30ac9300e0e26}{\index{energy@{energy}!icepower@{icepower}}
\index{icepower@{icepower}!energy@{energy}}
\subsubsection[{icepower}]{\setlength{\rightskip}{0pt plus 5cm}real(kind=prec) function energy\-::icepower (
\begin{DoxyParamCaption}
\item[{integer, dimension(nm), intent(in)}]{c, }
\item[{integer, intent(in)}]{t}
\end{DoxyParamCaption}
)}}\label{classenergy_a0f259e2e3c19a27638c30ac9300e0e26}
...
Definition at line 991 of file energy.\-f90.

\hypertarget{classenergy_ab4f365b315b8896a61c233c51db31696}{\index{energy@{energy}!icestoragelevelupdate@{icestoragelevelupdate}}
\index{icestoragelevelupdate@{icestoragelevelupdate}!energy@{energy}}
\subsubsection[{icestoragelevelupdate}]{\setlength{\rightskip}{0pt plus 5cm}real(kind=prec) function energy\-::icestoragelevelupdate (
\begin{DoxyParamCaption}
\item[{real(kind=prec), intent(in)}]{old\-Level, }
\item[{integer, dimension(nm), intent(in)}]{c, }
\item[{integer, intent(in)}]{t}
\end{DoxyParamCaption}
)}}\label{classenergy_ab4f365b315b8896a61c233c51db31696}
Updates the state of charge of vthe chilling storage according to old state of charge and present set point. \[ SOC_{th}(t) = SOC_{th}(t-1) sp_{th}\cdot P_{max}\eta \] where $sp(i)$ is the set point of the thermal storage $P_{max}(i)$ is its rated power and $\eta = \eta_{in}$ if $sp \le 0$ and $\eta = \eta_{out}$ if $sp \ge 0$ 
\begin{DoxyParams}[1]{Parameters}
\mbox{\tt in}  & {\em c\-\_\-} & index of the given set-\/point to be given as input. Defines the state of the plant $sp(i) = sp(c\_(i))$ \\
\hline
\mbox{\tt in}  & {\em t} & time index \\
...
Definition at line 902 of file energy.\-f90.



Referenced by constr\-::icestorageconstr(), and output().
...
Definition at line 587 of file energy.\-f90.
...
Definition at line 710 of file energy.\-f90.
...
Definition at line 751 of file energy.\-f90.
...
Definition at line 947 of file energy.\-f90.
...
Definition at line 249 of file energy.\-f90.
...
Definition at line 803 of file energy.\-f90.
...
\item 
/home/\-Progetti/\-Siat/\-Ottimizzatore/src/\hyperlink{energy_8f90}{energy.\-f90}\end{DoxyCompactItemize}
